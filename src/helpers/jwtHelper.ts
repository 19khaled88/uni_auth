import { IAccessTokenResponse, IRefreshTokenResponse, ITokenData } from "../app/modules/auth/interfacce";
...
export const createAccessToken=async(data:ITokenData)=>{
...
export const createRefreshToken=async(data:ITokenData)=>{
