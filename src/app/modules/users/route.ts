...
router.post('/create-admin',auth(ENUM_USER_ROLE.ADMIN,ENUM_USER_ROLE.SUPER_ADMIN),userController.createAdmin)
...
router.patch('/update-student/:id',auth(ENUM_USER_ROLE.ADMIN,ENUM_USER_ROLE.SUPER_ADMIN),validateRequest(UserZodValidation.updateStudnetZodSchema),studentController.updateStudent);
...
router.patch('/update-admin/:id',auth(ENUM_USER_ROLE.ADMIN,ENUM_USER_ROLE.SUPER_ADMIN),adminController.updateAdmin)
