...
router.post('/create-admin', (0, auth_1.auth)(user_1.ENUM_USER_ROLE.ADMIN, user_1.ENUM_USER_ROLE.SUPER_ADMIN), controller_1.userController.createAdmin);
//student routes
...
router.patch('/update-student/:id', (0, auth_1.auth)(user_1.ENUM_USER_ROLE.ADMIN, user_1.ENUM_USER_ROLE.SUPER_ADMIN), (0, validateRequest_1.default)(validation_1.UserZodValidation.updateStudnetZodSchema), controller_2.studentController.updateStudent);
...
router.patch('/update-admin/:id', (0, auth_1.auth)(user_1.ENUM_USER_ROLE.ADMIN, user_1.ENUM_USER_ROLE.SUPER_ADMIN), controller_3.adminController.updateAdmin);
